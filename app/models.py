...
class User(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "balance": self.balance, "role": self.role,
        }
...
class Odd(db.Model):
    ...
    def to_dict(self):
        return {
            "id": self.id, "market": self.market,
            "selection": self.selection, "value": self.value,
        }
...
class Transaction(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "reference": self.reference, "status": self.status, "createdAt": self.created_at.isoformat(),
        }
